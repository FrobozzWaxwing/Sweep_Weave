...
func _ready():
	...
	get_popup().add_item("Modified Time")
	get_popup().add_item("Option Count")
	get_popup().add_item("Reaction Count")
	get_popup().add_item("Effect Count")
	get_popup().add_item("Characters")
	get_popup().add_item("Spools")
