		...
		for encounter in storyworld.encounters:
			...
			for option in encounter.options:
				...
				if (null == option.visibility_script):
					...
					var details = "Error found in Encounter \"" + encounter.title + "\" / option \"" + option.text + "\" visibility script is null."
				...
				if (null == option.performability_script):
					...
					var details = "Error found in Encounter \"" + encounter.title + "\" / option \"" + option.text + "\" performability script is null."
				...
				for reaction in option.reactions:
					...
					if (null == reaction.desirability_script):
						...
						var details = "Error found in Encounter \"" + encounter.title + "\" / option \"" + option.text + "\" / reaction \"" + reaction.text + "\" performability script is null."
